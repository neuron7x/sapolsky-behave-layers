...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build the terminal trust-policy-bound two-family DGC global product qualification V4 authority."
    )
    ...
    authority = build_global_product_qualification_authority_v4(
    ...
    print(json.dumps({
        "status": "PASS_PRODUCT_QUALIFIED_RESEARCH_EVIDENCE",
