...
def build_harness_freeze(
    *,
    ...
    required_components = {
        "action_catalog_manifest", "benchmark_runtime_manifest", "executor_manifest", "model_manifest", "observation_provider_manifest", "prompt_policy", "tool_manifest", "environment",
    ...
    for policy_id in sorted(governance):
        harness = FrozenEvaluationHarness(
            ...
            benchmark_runtime_digest=components["benchmark_runtime_manifest"],
            model_manifest_digest=components["model_manifest"],
            observation_provider_digest=components["observation_provider_manifest"],
