...
def _doc() -> dict[str, object]:
    ...
    payload = {
        ...
        "methodology_anchors": [],
        "subject_root_manifest_digest": "3" * 64,
        "subject_roots": roots,
...
def test_valid_structural_p19_verifies(tmp_path: Path):
    assert verify_family_p19_evidence_root_document(_write(tmp_path, _doc()))["p19_sealed"] is True
