# DGC Product v1 — Archived Pre-execution Registration V3

Status: `SUPERSEDED_PRE_EXECUTION_PROTOCOL_V3 / EXTERNAL_CONFIRMATORY_OUTCOMES_UNOBSERVED`
Protocol generation: `DGC_PRODUCT_PAIRED_CLUSTER_AWARE_V3_WITH_G1_HOLDOUT`
Date frozen: 2026-08-23

This is the immutable text of the V3 preregistration immediately before V4 superseded it. V3 was superseded before external confirmatory outcomes were observed.

Primary claim authority: `docs/DGC_PRODUCT_CLAIM_v1.md`.
Statistical-plan authority at V3: `docs/DGC_PRODUCT_STATISTICAL_PLAN_v3.md`.
Mathematical authority at V3: `docs/DGC_STATISTICAL_AUTHORITY_V3.md`.
